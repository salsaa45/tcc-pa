...
exports.getEvents = async (req, res) => {
  console.log('GET /events endpoint hit'); // Add this line
  try {
    console.log('Attempting to fetch events from DB'); // Add this line
    const events = await EventModel.getAllEvents();
    console.log('Events fetched:', events); // Add this line
    res.json(events);
  } catch (error) {
